---
title: SagaSmith Web 与当前内容目录进入公开开发
titleEn: SagaSmith Web and the current content catalog enter public development
date: 2026-08-18
tag: PLATFORM
summary: SagaSmith Web、D&D/CoC 多系统房间与当前 46 个 Content Pack 的校验和目录现已公开可见，同时继续保留明确的状态与内容权利边界。
